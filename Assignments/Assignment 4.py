...
class PandasChain:
    ...
    def __commit_block(self, block):
        ...
        #block_hash =  hashlib.sha256(str(str(block) + str(self.__prev_hash)).encode('utf-8')).hexdigest()# Create block hash
        # Add code here
    ...
    def display_block_headers(self):
        ...
        #return self.__seq_id,self.__status,self.__block_hash,self.__prev_hash,self.__merkle_tx_hash,block.get_size()
